...
用于 AVCaptureSession 来建立和维护 AVCaptureInput 和 AVCaptureOutput 之间的连接 AVCaptureConnection 是 Session 和 Output 中间的控制节点，每个 Output 与 Session 建立连接后，都会分配一个默认的 AVCpatureConnection
